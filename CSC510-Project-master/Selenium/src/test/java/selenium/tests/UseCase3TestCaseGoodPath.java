...
public class UseCase3TestCaseGoodPath {
	...
	@Test
	public void useCase3TestCaseGoodPath()
	{
		...
		actions.click();
		actions.sendKeys("invitations emails list");
		...
		if(labelText.contains("Today") == true){
			...
			String checkString = "You have been invited to the following event";
			int lastIndex = 0;
			int count = 0;
