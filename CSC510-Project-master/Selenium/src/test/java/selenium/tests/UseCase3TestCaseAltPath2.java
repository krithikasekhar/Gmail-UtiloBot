...
public class UseCase3TestCaseAltPath2 {
	...
	@Test
	public void useCase3TestCaseAltPath2()
	{
		...
		email.sendKeys("maheshagrawal728@yahoo.com");
		...
		actions.click();
		actions.sendKeys("list all pending invitation emails");
		...
		if(labelText.contains("Today") == true){
			...
			String checkString = "I don't have your gmail account info, please provide me your gmail id along with token in the following form:";
