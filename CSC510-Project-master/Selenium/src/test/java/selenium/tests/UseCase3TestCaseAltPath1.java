...
public class UseCase3TestCaseAltPath1 {
	...
	@Test
	public void useCase3TestCaseAltPath1()
	{
		...
		actions.click();
		actions.sendKeys("give me all invitation emails");
		...
		if(labelText.contains("Today") == true){
			...
			String checkString = "No emails related to gmail invitation found";
