...
public class UseCase2TestCaseAltPath1 {
	...
	@Test
	public void useCase2TestCaseAltPath1()
	{
		...
		email.sendKeys("ashimasingh91@gmail.com");
		...
		actions.click();
		actions.sendKeys("give me all github issue related emails");
		...
		if(labelText.contains("Today") == true){
			...
			String checkString = "No emails related to Github issues found";
